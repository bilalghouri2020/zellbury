...
import MissingItemMessageDetails from './MissingItemMessageDetails.component';
import {
    COMPLAIN_CONFIRM,
    CONFIRM_POPUP_ID
...
class MissingItemMessageContainer extends PureComponent {
    static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(MissingItemMessageContainer);