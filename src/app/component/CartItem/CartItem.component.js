...
export class CartItem extends PureComponent {
    ...
    renderActions() {
        ...
        if (variants && variants.length > 0) {
            ...
            if (curentItem && Object.keys(curentItem.attributes).length > 0 && curentItem.attributes.is_in_meter && Object.keys(curentItem.attributes.is_in_meter).length > 0 && curentItem.attributes.is_in_meter.attribute_value == '1') {
                IsInMeter = true;
            }
        }
        else {
            if (attributes && attributes.is_in_meter) {
                IsInMeter = true;
            }
        }
        return (
            ...
            >
                ...
                <Field
                    customePlusStyle={{ paddingRight: '0px', fontSize: '1em' }}
                    customeMinusStyle={{ position: "static", paddingLeft: "0px", fontSize: '1em' }}
                    IsInMeter={IsInMeter}
                    id="item_qty"
                    name="item_qty"
                    type="number"
