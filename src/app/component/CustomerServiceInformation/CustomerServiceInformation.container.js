...
import CustomerServiceInformation from './CustomerServiceInformation.component';

export default class CustomerServiceInformationContainer extends PureComponent {
    static propTypes = {
